 ...
 * – validate pool structure and participants
 * – compute liquidity sustainability scores
 */
...
/**
 * Resolve a liquidity tool by its key.
 */
...
/**
 * Check if a given tool key exists in the toolkit.
 */
